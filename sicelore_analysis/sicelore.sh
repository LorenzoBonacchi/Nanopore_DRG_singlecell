...
java -jar -Xmx32g  ../../tools/sicelore-2.1/Jar/Sicelore-2.1.jar SelectValidCellBarcode I=BarcodesAssigned.tsv O=ValidBarcodes.csv MINUMI=100 ED0ED1RATIO=4
java -jar -Xmx64g  ../../tools/sicelore-2.1/Jar/Sicelore-2.1.jar  IsoformMatrix I=adeno_sc4_sicelore_assigned.bam  GENETAG=GE UMITAG=U8 CELLTAG=BC REFFLAT=gencode.vM38.refFlat CSV=ValidBarcodes.csv DELTA=2 MAXCLIP=150 METHOD=STRICT AMBIGUOUS_ASSIGN=false OUTDIR=. PREFIX=sicelore
